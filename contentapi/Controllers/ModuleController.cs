...
namespace contentapi.Controllers
{
    ...
    public class ModuleController : BaseSimpleController
    {
        ...
        protected IPermissionService permService;

        public ModuleController(ILogger<BaseSimpleController> logger, UserViewService service, IPermissionService permissionService) 
            : base(logger) 
        { 
